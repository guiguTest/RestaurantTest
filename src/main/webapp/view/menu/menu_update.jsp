...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
	<form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/menu/update.action" id="registForm">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="menuId" value="${menu.menuId}" placeholder="编号">
            </div>
          </div>
          ...
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <button type="submit" class="am-btn am-btn-primary" id="registForm">保存</button>
            </div>
          </div>
