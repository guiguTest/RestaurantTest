...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
	<form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/user/add.action">
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-1">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
				<p class="form-control-static">${user.userQq}</p>	
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
				<p class="form-control-static">${user.userNote}</p>
            </div>
          </div>

          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <a href="${pageContext.request.contextPath}/user/list.action" class="am-btn am-btn-primary">退出</a>	
            </div>
          </div>
      </div>
    </form>
